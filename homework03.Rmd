...
#Team member: Brett Simmons https://github.com/BrettSimmons/practice1-BrettSimmons
#I made 1 successful pull request and accepted one pull request from https://github.com/nathancatalano/practice-1-nathancatalano


    c. Write down a list with at least 3 tips of how to make working with git/github easier  
#3 tips on working with github easier is to practice making edits and pull requests, working with team members, and organizing files
